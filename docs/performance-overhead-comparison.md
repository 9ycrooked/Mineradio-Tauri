...
| ------------ | ------ | ----------- | ---------------- | ----- | ------ | --- |
| Electron 原项目 | 1243   | 12.2        | 568.6            | 0.26  | 1001.4 | 9   |
| Tauri 优化前    | 712    | 14.4        | 427.2            | 0.42  | 240.5  | 8   |
| Tauri 当前优化版  | 712    | 14.7        | 508.7            | 0.26  | 298.8  | 8   |

当前优化版相对 Tauri 优化前: 初始 JS Heap 变化 +1.7%，Electron RSS 变化 +19.1%，CPU 样本变化 -38.9%。
当前优化版相对 Electron 原项目: 初始 JS Heap 变化 +20.0%，Electron RSS 变化 -10.5%，CPU 样本变化 -0.3%。

## Tauri 热点渲染开销

| 场景         | 优化前 rows | 优化后 rows | rows 下降 | 优化前 DOM | 优化后 DOM | DOM 下降 | CPU ms 变化 | Wall ms 变化 |
| ---------- | -------- | -------- | ------- | ------- | ------- | ------ | --------- | ---------- |
| 队列面板 240 首 | 240      | 13       | 94.6%   | 2659    | 162     | 93.9%  | -87.6%    | -74.4%     |
| 歌单详情 600 首 | 600      | 15       | 97.5%   | 3039    | 114     | 96.2%  | -71.6%    | -84.4%     |
| 迷你队列 240 首 | 240      | 12       | 95.0%   | 2034    | 210     | 89.7%  | -90.4%    | -84.8%     |
| 搜索结果 180 首 | 180      | 12       | 93.3%   | 3084    | 228     | 92.6%  | -93.1%    | -88.3%     |
